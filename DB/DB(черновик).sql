...
Delete From Products_Awaiting_Approval Where id_product>1750962;
...
alter table Products_Awaiting_Approval alter column name_product nvarchar(20) not null
...
insert into Products(name_product, calorific_product,protein_product,fat_product,carbs_product) values ('Картофельуш', 123,1.4, 1.6, 1.8);
